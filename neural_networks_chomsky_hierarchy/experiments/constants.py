...
from neural_networks_chomsky_hierarchy.models import looped_transformer
...
MODEL_BUILDERS = {
    ...
    "stack_rnn": functools.partial(
        rnn.make_rnn, rnn_core=stack_rnn.StackRNNCore, inner_core=hk.VanillaRNN
    ),
    "ndstack_rnn": functools.partial(
        rnn.make_rnn, rnn_core=ndstack_rnn.NDStackRNNCore, inner_core=hk.VanillaRNN
    ),
    "stack_lstm": functools.partial(
    ...
    "looped_transformer_encoder": looped_transformer.make_transformer_encoder,
    "looped_transformer": looped_transformer.make_transformer,
    "tape_rnn": functools.partial(
        rnn.make_rnn,
...
TASK_BUILDERS = {
    ...
    "reverse_string": reverse_string.ReverseString,
    "missing_duplicate_string": missing_duplicate_string.MissingDuplicateString,
    "duplicate_string": duplicate_string.DuplicateString,
    ...
    "odds_first": odds_first.OddsFirst,
