...
torchrun --standalone --nproc_per_node=4 train.py config/train_looped_wikitext-103.py
# torchrun --standalone --nproc_per_node=4 train.py config/train_dynamic_looped_wikitext-103.py